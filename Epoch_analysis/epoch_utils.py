...
def calculate_lower_hybrid_frequency(
    ...
    Parameters:
        ...
        unit (str): 'si' or 'cyc' -- Unit to be returned, 'si' for Hz or 'cyc' for ion cyclotron frequency. Default is cyc
    ...
    cyclotron_freq_ion = (ion_charge * B0) / (TWO_PI * ion_mass)
    cyclotron_freq_electron = (constants.elementary_charge * B0) / (TWO_PI * constants.electron_mass)
