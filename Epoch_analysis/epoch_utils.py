...
def create_power_spectra(
    ...
    # Get power spectrum
    ps = xrft.power_spectrum(fieldData, scaling = "spectrum", window = 'hann', window_correction=True, detrend = "linear") # PS over space and time
    ...
    psd = xrft.power_spectrum(fieldData, scaling = "density", window = 'hann', window_correction=True, detrend = "linear")
